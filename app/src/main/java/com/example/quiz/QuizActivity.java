...
public class QuizActivity extends AppCompatActivity {
    ...
    private  static  final  String KEY_QUestion_COUNT = "KeyQuestion";
    ...
    private ColorStateList getTextColorDefaultRb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int categoryID = intent.getIntExtra(MainActivity.EXTRA_CATEGORY_NAME,);
        String categoryName = intent.getStringExtra(MainActivity.EXTRA_CATEGORY_NAME);
        String difficulty = intent.getStringExtra(MainActivity.EXTRA_DIFFICLTY);
        ...
        if (savedInstanceState == null) {
            ...
            questionList = dbHelper.getQuestions(categoryID,"%E%");
...
private void UpdateCountDownText(){
        ...
        String timeFormatted = String.format(Locale.getDefault() , "%02d:%2d",minutes,seconds);
